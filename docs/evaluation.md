...
For the current curated 200-sample results and image-understanding sanity-check
analysis, see [Evaluation Results And Sanity Checks](evaluation-results-and-sanity.md).
